...
@section('styles')
    ...
    <!-- Font Awesome -->
    <link href="{{ asset('assets/plugins/ontawesome-free/css/all.min.css') }}" rel="stylesheet">
    <!-- DataTables -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">DataTable for all ads from with user-email</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
...
@section('scripts')
    ...
    <script src="{{ asset('assets/plugins/jquery/jquery.min.js') }}"></script><!-- Bootstrap 4 -->
    <script src="../../plugins/"></script>
